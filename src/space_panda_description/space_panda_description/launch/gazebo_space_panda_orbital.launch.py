...
def generate_launch_description():
    ...
    spawn_entity = Node(
        ...
        arguments=[
            ...
            "-x", "0.0",
            "-y", "0.0", 
            "-z", "0.0",  # Start at origin for easy viewing (change to 400.0 for orbit)
        ],
        output="screen",
    )
    ...
    orbital_controller = Node(
        ...
        output="screen",
        parameters=[{
            "orbit_radius": 2400.0,  # 400m above Earth surface at -2000m
            "earth_position": [0.0, 0.0, -2000.0],
            "initial_position": [0.0, 0.0, 400.0],
            "orbital_velocity": 0.5,  # Simplified orbital speed
        }]
    )
